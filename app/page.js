                        ...
                        <li className="uc-open  ">
                          ...
                          <div className="uc-accordion-content">
                            <p>
                              ...
                              in dealing with HTML/CSS as well as JavaScript in
                              order to be able to use Lexend.
                            </p>
                          </div>
                        </li>
                        <li className="  ">
                        ...
                        <li className="  ">
                          ...
                          <div className="uc-accordion-content">
                            <p>
                              ...
                              due to the nature of our products and services, we
                              do not offer refunds after a purchase has been
                              made.
                            </p>
                          </div>
                        </li>
                        ...
                        <div className="px-3 sm:px-4 py-4 panel vstack justify-between gap-3 rounded-2 border">
                          <div className="panel vstack items-start gap-2">
                            ...
                            <p className="fs-6 lg:fs-5 text-dark dark:text-white text-opacity-70">
                              ...
                              get approval from my boss all within 36 minutes.”
                            </p>
                          </div>
                          <div className="panel hstack gap-2 mt-2 lg:mt-4">
                            <img
                        ...
                        <div className="px-3 sm:px-4 py-4 panel vstack justify-between gap-3 rounded-2 border">
                          <div className="panel vstack items-start gap-2">
                            ...
                            <p className="fs-6 lg:fs-5 text-dark dark:text-white text-opacity-70">
                              ...
                              service suppliers that comply with this regulation
                              and as we look to create our website and this
                              builder just outstanding!”
                            </p>
                          </div>
                          <div className="panel hstack gap-2 mt-2 lg:mt-4">
                            <img
